 ...
 * Tue Apr 16 2024 18:20:39 GMT+0530 (India Standard Time)
...
var z, clonedred, dictred, y, dictpink, x, clonedyellow, clonedpink, dictyellow;
...
function drag1(z) {
  registerOnClick(z, false, false, [0,1,2], function() {
    registerOnDrag(z, false, [0,1,2], function() {}, function() {
      dragMove(z, 'XYZ', 'n_P?iK*P;O52eF?(yi6s', '`k)Ql.Nq%?DmHFAE?8c]');
    }, function() {
      dictSet(dictred, z, getObjTransform(z, false, 'position', 'xyz'));
      console.log(dictred);
    }, '`k)Ql.Nq%?DmHFAE?8c]');
  }, function() {});
}
...
// Describe this function...
function drag2(y) {
  registerOnClick(y, false, false, [0,1,2], function() {
    registerOnDrag(y, false, [0,1,2], function() {}, function() {
      dragMove(y, 'XYZ', ';|hTY{X9tizpp@oQy8o9', ']TgyjkyF5ak3HGzp]qO9');
    }, function() {
      dictSet(dictyellow, y, getObjTransform(y, false, 'position', 'xyz'));
      console.log(dictyellow);
    }, ']TgyjkyF5ak3HGzp]qO9');
  }, function() {});
}
...
function drag3(x) {
  registerOnClick(x, false, false, [0,1,2], function() {
    registerOnDrag(x, false, [0,1,2], function() {}, function() {
      dragMove(x, 'XYZ', 'sjR#u6@!*GnimZge[8/L', 'ejr(nS}a1X(-X2^,|L4N');
    }, function() {
      dictSet(dictpink, x, getObjTransform(x, false, 'position', 'xyz'));
      console.log(dictpink);
    }, 'ejr(nS}a1X(-X2^,|L4N');
  }, function() {});
}
...
setHTMLElemStyle('background', 'white', 'save', false);
setHTMLElemStyle('height', '65px', 'save', false);
setHTMLElemStyle('width', '65px', 'save', false);
setHTMLElemAttribute('innerHTML', 'Save', 'save', false);

addHTMLElement('button', 'load', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('background', 'blue', 'load', false);
setHTMLElemStyle('height', '65px', 'load', false);
setHTMLElemStyle('width', '65px', 'load', false);
setHTMLElemAttribute('innerHTML', 'Load', 'load', false);

changeVis('size-reference.001', false);
addHTMLElement('button', 'red', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('background', 'red', 'red', false);
setHTMLElemStyle('height', '65px', 'red', false);
setHTMLElemStyle('width', '65px', 'red', false);
setHTMLElemAttribute('innerHTML', 'Red', 'red', false);
eventHTMLElem('click', 'red', false, function(event) {
  changeVis('size-reference.001', true);
});
registerOnDrag('size-reference.001', false, [0,1,2], function() {}, function() {
  dragMove('size-reference.001', 'XYZ', 'xYg%AYk6r/3C~[v9Dh2S', 'P(kLMk7Bcm,|2oMR7l`-');
}, function() {}, 'P(kLMk7Bcm,|2oMR7l`-');

clonedred;

eventHTMLElem('dblclick', 'red', false, function(event) {
  clonedred = cloneObject('size-reference.001');
  setObjTransform(clonedred, false, 'position', [-9, -22, 0.75], false);
...
changeVis('Cylinder.002', false);
addHTMLElement('button', 'yellow', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('backgroundColor', 'yellow', 'yellow', false);
setHTMLElemStyle('height', '65px', 'yellow', false);
setHTMLElemStyle('width', '65px', 'yellow', false);
setHTMLElemAttribute('innerHTML', 'Yellow', 'yellow', false);
...
registerOnDrag('Cylinder.002', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder.002', 'XYZ', 'irt$oL!w4[0Rv,X5.62x', '/iq#O_%^1BgNf{s.Uv)-');
}, function() {
  drag2(clonedyellow);
}, '/iq#O_%^1BgNf{s.Uv)-');
...
registerOnDrag('Plane', false, [0,1,2], function() {}, function() {
  dragMove('Plane', 'XYZ', 'i|$K@44MnAJ-*;GID[ID', '!3YQ;?klV32z`#KZG{)@');
}, function() {}, '!3YQ;?klV32z`#KZG{)@');

eventHTMLElem('dblclick', 'yellow', false, function(event) {
  clonedyellow = cloneObject('Cylinder.002');
  setObjTransform(clonedyellow, false, 'position', [-9, -17, 0.75], false);
  changeVis(clonedyellow, true);
  drag2(clonedyellow);
});

registerOnDrag('Cube.005', false, [0,1,2], function() {}, function() {
  dragMove('Cube.005', 'XYZ', 'c8?$Rn[rxfFzWD+Iszk6', '3;ICDC($a{!AaxwPyD6G');
}, function() {}, '3;ICDC($a{!AaxwPyD6G');

dictred = {};
dictSet(dictpink, 'x3', getObjTransform(clonedpink, false, 'position', 'x'));
dictSet(dictpink, 'y3', getObjTransform(clonedpink, false, 'position', 'y'));
dictSet(dictpink, 'z3', getObjTransform(clonedpink, false, 'position', 'z'));

setObjTransform('Plane', false, 'scale', [5, 5, 5], false);
setObjTransform('Plane', false, 'rotation', [180, 180, 180], false);
setObjTransform('Plane', false, 'position', [-10, -20, 0], false);

changeVis('Cube.001', false);
addHTMLElement('button', 'pink', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('backgroundColor', 'pink', 'pink', false);
setHTMLElemStyle('height', '65px', 'pink', false);
setHTMLElemStyle('width', '65px', 'pink', false);
setHTMLElemAttribute('innerHTML', 'Pink', 'pink', false);
...
registerOnDrag('Cube.001', false, [0,1,2], function() {}, function() {
  dragMove('Cube.001', 'XYZ', '4oP{jrud{cb9Ro~`!Om!', '1^J6j!aye|#=E]B6ruJt');
}, function() {}, '1^J6j!aye|#=E]B6ruJt');

setObjTransform('Cube.005', false, 'position', [0, 0, 0], false);
setObjTransform('Cube.001', false, 'position', [-13, -17, 0.75], false);
setObjTransform('Cylinder.002', false, 'position', [-9, -17, 0.75], false);
setObjTransform('size-reference.001', false, 'position', [-9, -22, 0.75], false);

dictpink = {};

eventHTMLElem('dblclick', 'pink', false, function(event) {
  clonedpink = cloneObject('Cube.001');
  setObjTransform(clonedpink, false, 'position', [-13, -17, 0.75], false);
